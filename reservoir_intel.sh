...
do
    ...
    --experiment_name=network/${output}/${next} --epochs_til_ckpt=100 --num_epochs=1500 --train_mode=2 --reservoir_path=${location}/${dataset}_sampled_buffer/${frame}.xyz --last_checkpoint=logs/network/${output}/${frame}/checkpoints/model_current.pth
